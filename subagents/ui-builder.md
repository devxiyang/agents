...
**Common Shadcn components (use MCP for complete list):**
...
**Note:** This is a quick reference only. ALWAYS use MCP tools to discover the latest components, get detailed documentation, and view usage examples.
...
- **🔍 USE MCP FIRST** — ALWAYS use Shadcn MCP tools to discover components, view documentation, and get examples BEFORE implementing
- **📚 Check examples** — Use `mcp__shadcn__get_item_examples_from_registries` to see real-world usage patterns and best practices
